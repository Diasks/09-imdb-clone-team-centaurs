                                            ...
                                            <div class="tab-content" id="v-pills-tabContent">
                                                <div class="tab-pane fade show active edit-profile-tab" role="tabpanel"
                                                                ...
                                                                <div class="col-6 col-xs-6 right-btn-container">
                                                                    <label class="btn btn-primary <?php if ($user->profile->avatar_status == 0): ?> active <?php endif; ?> btn-block btn-sm"
                                                                        ...
                                                                        <input type="radio" name="avatar_status"
                                                                               ...
                                                                               value="0" <?php if ($user->profile->avatar_status == 0): ?> checked <?php endif; ?>>
                                                                        Use Gravatar
                                                                    </label>
                                                                </div>
                                                                <div class="col-6 col-xs-6 left-btn-container">
                                                                    <label class="btn btn-primary <?php if ($user->profile->avatar_status == 1): ?> active <?php endif; ?> btn-block btn-sm"
                                                                        ...
                                                                        <input type="radio" name="avatar_status"
                                                                               ...
                                                                               value="1" <?php if ($user->profile->avatar_status == 1): ?> checked <?php endif; ?>>
                                                                        Use My Image
                                                                    </label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="form-group has-feedback <?php echo e($errors->has('theme') ? ' has-error ' : ''); ?>">
                                                        <?php echo Form::label('theme_id', trans('profile.label-theme'),
                                                            array('class' => 'col-12 control-label'));; ?>

                                                        <div class="col-12">
                                                            <select class="form-control" name="theme_id" id="theme_id">
                                                                <?php if ($themes->count()): ?>
                                                                    <?php $__currentLoopData = $themes;
                                                                    $__env->addLoop($__currentLoopData);
                                                                    foreach ($__currentLoopData as $theme): $__env->incrementLoopIndices();
                                                    ...
                                                    <div class="form-group has-feedback <?php echo e($errors->has('location') ? ' has-error ' : ''); ?>">
                                                        <?php echo Form::label('location',
                                                            trans('profile.label-location'),
                                                            array('class' => 'col-12 control-label'));; ?>

                                                        <div class="col-12">
                                                            <?php echo Form::text('location', old('location'), array(
                                                                'id' => 'location',
                                                                'class' => 'form-control',
                                                    ...
                                                    <div class="form-group has-feedback <?php echo e($errors->has('bio') ? ' has-error ' : ''); ?>">
                                                        <?php echo Form::label('bio', trans('profile.label-bio'),
                                                            array('class' => 'col-12 control-label'));; ?>

                                                        <div class="col-12">
                                                            <?php echo Form::textarea('bio', old('bio'), array(
                                                                'id' => 'bio',
                                                                'class' => 'form-control',
                                                    ...
                                                    <div class="form-group has-feedback <?php echo e($errors->has('twitter_username') ? ' has-error ' : ''); ?>">
                                                        <?php echo Form::label('twitter_username',
                                                            trans('profile.label-twitter_username'),
                                                            array('class' => 'col-12 control-label'));; ?>

                                                        <div class="col-12">
                                                            <?php echo Form::text('twitter_username',
                                                                old('twitter_username'), array(
                                                                    'id' => 'twitter_username',
                                                                    'class' => 'form-control',
                                                    ...
                                                    <div class="margin-bottom-2 form-group has-feedback <?php echo e($errors->has('github_username') ? ' has-error ' : ''); ?>">
                                                        <?php echo Form::label('github_username',
                                                            trans('profile.label-github_username'),
                                                            array('class' => 'col-12 control-label'));; ?>

                                                        <div class="col-12">
                                                            <?php echo Form::text('github_username',
                                                                old('github_username'), array(
                                                                    'id' => 'github_username',
                                                                    'class' => 'form-control',
                                                ...
                                                <div class="tab-pane fade edit-settings-tab" role="tabpanel"
                                                    ...
                                                    <?php echo Form::model($user, array(
                                                        'action' => array(
                                                            'ProfilesController@updateUserAccount',
                                                            $user->id
                                                        ),
                                                        'method' => 'PUT',
                                                        'id' => 'user_basics_form'
                                                    ...
                                                    <div class="pt-4 pr-3 pl-2 form-group has-feedback row <?php echo e($errors->has('name') ? ' has-error ' : ''); ?>">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                <?php echo Form::text('name', $user->name, array(
                                                                    'id' => 'name',
                                                                    'class' => 'form-control',
                                                    ...
                                                    <div class="pr-3 pl-2 form-group has-feedback row <?php echo e($errors->has('email') ? ' has-error ' : ''); ?>">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                <?php echo Form::text('email', $user->email, array(
                                                                    'id' => 'email',
                                                                    'class' => 'form-control',
                                                ...
                                                <div class="tab-pane fade edit-account-tab" role="tabpanel"
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div id="changepw" class="tab-pane fade show active">
                                                            ...
                                                            <?php echo Form::model($user, array(
                                                                'action' => array(
                                                                    'ProfilesController@updateUserPassword',
                                                                    $user->id
                                                                ),
                                                                'method' => 'PUT',
                                                        ...
                                                        <div id="deleteAccount" class="tab-pane fade">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6 offset-sm-3 margin-bottom-3 text-center">
                                                                    ...
                                                                    <?php echo Form::model($user, array(
                                                                        'action' => array(
                                                                            'ProfilesController@deleteUserAccount',
                                                                            $user->id
                                                                        ),
                                                                        'method' => 'DELETE'
                                                                    )); ?>
...
<?php echo $__env->make('modals.modal-form',
...
<?php echo $__env->make('scripts.form-modal-script',
    \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

<?php if (config('settings.googleMapsAPIStatus')): ?>
    <?php echo $__env->make('scripts.gmaps-address-lookup-api3',
        \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php endif; ?>

<?php echo $__env->make('scripts.user-avatar-dz',
    \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
