            ...
            <div class="col-sm-9 col-md-10 table-container">
                ...
                <?php else: ?>
                    <table id="table-log" class="table table-sm table-striped">
                        ...
                        $__env->addLoop($__currentLoopData);
                        foreach ($__currentLoopData as $key => $log): $__env->incrementLoopIndices();
                            $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="text">
                                    ...
                                    <?php if (isset($log['in_file'])): ?>
                                        <br/><?php echo e($log['in_file']); ?><?php endif; ?>
                                    <?php if ($log['stack']): ?>
                                        <div class="stack" id="stack<?php echo e($key); ?>"
                                             style="display: none; white-space: pre-wrap;"><?php echo e(trim($log['stack'])); ?></div><?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach;
                        $__env->popLoop();
                ...
                <div>
                    <?php if ($current_file): ?>
                        ...
                        -
                        <a id="delete-log" data-toggle="modal" data-target="#confirmDelete"
                           data-href="?del=<?php echo e(base64_encode($current_file)); ?>" data-title="Delete Log File"
                           data-message="Are you sure you want to delete log file?" class="btn btn-link">
                        ...
                        <?php if (count($files) > 1): ?>
                            ...
                            <a id="delete-all-log" data-toggle="modal" data-target="#confirmDelete"
                               data-href="?delall=true" data-title="Delete All Log Files"
                               data-message="Are you sure you want to delete all log files?" class="btn btn-link">
