    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <?php echo e(trans('themes.themesTitle')); ?>
                <strong><?php echo e(count($themes)); ?></strong> <?php echo e(trans('themes.themes')); ?>
                ...
                <div class="table-responsive themes-table">
                    <table class="table table-striped table-sm data-table">
                        ...
                        foreach ($__currentLoopData as $aTheme): $__env->incrementLoopIndices();
                            ...
                            <tr>
                                ...
                                <td>
                                        <span class="label label-<?php echo e($themeCountClass); ?>"
                                ...
                                <td class="hidden-xs hidden-sm hidden-md">
                                    <a href="<?php echo e($aTheme->link); ?>" target="_blank" data-toggle="tooltip"
                                       title="Go to Link">
                                ...
                                <td>
                                    <a class="btn btn-sm btn-success btn-block"
                                       href="<?php echo e(URL::to('themes/' . $aTheme->id)); ?>" data-toggle="tooltip"
                                       title="<?php echo e(trans('themes.themesBtnShow')); ?>">
                                ...
                                <td>
                                    <a class="btn btn-sm btn-info btn-block"
                                       href="<?php echo e(URL::to('themes/' . $aTheme->id . '/edit')); ?>"
                                       data-toggle="tooltip" title="<?php echo e(trans('themes.themesBtnEdit')); ?>">
                                ...
                                <td>
                                    ...
                                    <?php echo Form::button('<i class="fa fa-trash-o fa-fw" aria-hidden="true"></i> <span class="sr-only">Delete Theme</span>',
                                        array(
                                            ...
                                            'data-title' => trans('themes.confirmDeleteHdr'),
                                            'data-message' => trans('themes.confirmDelete')
                                        )); ?>
...
<?php echo $__env->make('modals.modal-delete',
...
<?php if (count($themes) > 50): ?>
    <?php echo $__env->make('scripts.datatables',
        \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php endif; ?>
<?php echo $__env->make('scripts.delete-modal-script',
    \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('scripts.save-modal-script',
    \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('scripts.tooltips',
    \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
