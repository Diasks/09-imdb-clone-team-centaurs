                    ...
                    <div class="card-body">
                        ...
                        <dl class="user-info">
                            ...
                            <?php if ($user->profile): ?>
                                ...
                                <?php if ($user->profile->twitter_username): ?>
                                    ...
                                    <dd>
                                        <?php echo HTML::link('https://twitter.com/' . $user->profile->twitter_username,
                                ...
                                <?php if ($user->profile->github_username): ?>
                                    ...
                                    <dd>
                                        <?php echo HTML::link('https://github.com/' . $user->profile->github_username,
                        ...
                        <?php if ($user->profile): ?>
                            <?php if (Auth::user()->id == $user->id): ?>
                                ...
                                <?php echo HTML::icon_link(URL::to('/profile/' . Auth::user()->name . '/edit'),
...
<?php if (config('settings.googleMapsAPIStatus')): ?>
    <?php echo $__env->make('scripts.google-maps-geocode-and-map',
